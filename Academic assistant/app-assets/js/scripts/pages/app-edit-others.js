...
window.onload = function () {
    ...
    if (id != "../upload/null.pdf") {
        ...
        $.ajax({
            ...
            data: { "meth": "others", userid: document.cookie.split("=")[0], "paperid": paperid },
            dataType: "json",
            success: function (data) {
                console.log(data);
                $("input[name='title']").val(data[0].Achievementname)
...
function uploaddetail(timestamp,draft) {
        var others = {
           ...
           paperid:timestamp,
           Achievementname:$("input[name='title']").val(),
